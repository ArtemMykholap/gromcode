 ...
 */
export const newPromise = (...promiseNumbers) => Promise.all(promiseNumbers)

const resultPromise = newPromise(promiseNumber1, promiseNumber2, promiseNumber3) /* ...code here */
